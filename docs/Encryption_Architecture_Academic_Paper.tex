...
\title{Post-Quantum Hybrid Encryption Architecture for Secure Messaging: The ToledoMessage Approach}
\author{}
\date{March 2026}
...
\end{equation}
\begin{equation}
\text{SK} = \text{HKDF}(\text{IKM}, \text{info}=``\text{ToledoMessage-HybridKEM-v1}'', L=32)
\end{equation}
