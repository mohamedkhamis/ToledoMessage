...
**ID Convention**: All entity IDs are `decimal` values generated by `DecimalTools.GetNewId()`. Serialized as JSON numbers (e.g., `638765432100000000.12345678`).
...
```json
{
  "userId": 638765432100000000.12345678,
  "displayName": "alice",
...
```json
{
  "deviceId": 638765432100000000.87654321
}
```
...
```json
{
  "users": [
    {
      "userId": 638765432100000000.11111111,
      "displayName": "bob",
      "deviceCount": 2
    }
  ]
...
```json
{
  "messageIds": [638765432100000000.44444444, 638765432100000000.55555555]
}
```
...
{
  "type": 0,
  "participantUserIds": [638765432100000000.12345678, 638765432100000000.11111111],
...
```json
{
  "userId": 638765432100000000.66666666
}
```
