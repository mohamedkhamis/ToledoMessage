...
namespace ToledoVault.Shared.Constants;
...
public static class ProtocolConstants
{
    ...
    public const string HkdfInfoRootKey = "ToledoVault_RootKey";
    public const string HkdfInfoChainKey = "ToledoVault_ChainKey";
    public const string HkdfInfoMessageKey = "ToledoVault_MessageKey";
}
