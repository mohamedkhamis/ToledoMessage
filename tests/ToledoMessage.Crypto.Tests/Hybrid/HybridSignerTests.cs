...
public class HybridSignerTests
{
    ...
    public void Verify_AcceptsV0LegacyFormat()
    {
        ...
        var ed25519Sig = ToledoMessage.Crypto.Classical.Ed25519Signer.Sign(classicalPrivate, message);
        var mlDsaSig = ToledoMessage.Crypto.PostQuantum.MlDsaSigner.Sign(pqPrivate, message);
